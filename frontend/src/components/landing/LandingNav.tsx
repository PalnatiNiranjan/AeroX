...
export const LandingNav: React.FC = () => {
  ...
  return (
    // bg-white removed — LandingPage.tsx wraps LandingNav + Hero in a
    // shared bg-[var(--color-sky)] container so the nav and the cinematic
    // hero read as one continuous surface. Hairline bottom border also
    // removed (was kept in the previous pass as a deliberate separator,
    // but the ask now is a fully seamless surface, no divider at all).
    <header className="relative z-10 flex items-start justify-between px-6 pt-8 md:px-12 md:pt-10">
      <motion.button
        ...
        style={{
          // Reduced ~17.5% from the prior 131px/2.75rem/8vw token to sit
          // more in balance with the nav links beside it. letterSpacing
          // scaled down by the same ratio (was tuned specifically for
          // 131px) so the tracking looks the same, not tighter, at the
          // smaller size.
          fontSize: 'clamp(2.25rem, 6.5vw, 108px)',
          lineHeight: 0.85,
